...
//############################################################################
{
    ...
    {
       FAT_DEBUG("MBR Assinatura encontrada!\r\n"); 
    }
    else
    {
       FAT_DEBUG("Assinatura MBR nao encontrada!\r\n"); 
	   //reboot(); //programa deve entrar em loop eterno caso n encontre MBR
	   while(1){}
    }
    ...
    if (Buffer[510] == 0x55 && Buffer[511] == 0xAA)
    {
       FAT_DEBUG("VBR Assinatura encontrada!\r\n"); 
    }
    else
    {
       FAT_DEBUG("VBR Assinatura nao encontrada!\r\n"); 
...
void fat_read_file (unsigned int Cluster,//datas do cluster a partir do arquivo
